 ...
 * @author aluno02.itb
 */
public class Titulacao extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Cadastro de Titulação");
        setResizable(false);
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(ctDescricao, javax.swing.GroupLayout.PREFERRED_SIZE, 314, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
    ...
    private void gravar(){
        ...
        try{
            String sql = "INSERT INTO TITULACAO(descricao, observacoes)"
                    + "VALUES('" + xDescricao + "','" + xObservacoes + "')";
            System.out.println(sql);
            Statement stm = VariaveisPublicas.ConexaoPadrao.createStatement();
            stm.executeUpdate(sql);
            stm.close();
            JOptionPane.showMessageDialog(null, "Titulação Cadastrada!", "Cadastro de Titulação",
            ...
            Logger.getLogger(Titulacao.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Titulacao.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
